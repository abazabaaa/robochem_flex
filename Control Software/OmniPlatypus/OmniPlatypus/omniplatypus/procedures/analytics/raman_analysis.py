...
Descr: Rama lama runner for our purposes
...
class AnalyticsRaman(AnalyticsTemplate):
    ...
    _base_data = os.path.join( "raman_spectra")
    ...
    _optional_parameters: list[AnalyticalParameter] = [
        ...
        AnalyticalParameter(name="fluorescence_check", value=True, tag="all"),
        AnalyticalParameter(name="fluorescence_threshold", value=800, tag="all"),
        # AnalyticalParameter(
    ...
    _processing_methods = ["isosbestic_integral"]
...
class dummyRamanAnalytics(AnalyticsRaman):
    def analyse(
        self,
        conditions: dict[
            str, ExperimentalParameter | NumericalParameter | AnalyticalParameter
