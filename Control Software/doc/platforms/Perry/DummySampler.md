...
| **feed** | READ/WRITE | float | Set feed-rate| 0.0 <= value <= 6000.0  mm/min, | 
| **move** | WRITE ONLY | GrblPosition | Move to an absolute work position at the feed rate| [X=0.0, Y=0.0, Z=-76.5] <= value <= [X=172.0, Y=290.0, Z=0.0] , | 
| **fast_move** | WRITE ONLY | GrblPosition | Move to an absolute work position as fast as possible| [X=0.0, Y=0.0, Z=-76.5] <= value <= [X=172.0, Y=290.0, Z=0.0] , | 
